...
public class ExportService {
    ...
    public byte[] buildPdf(LocalDate from, LocalDate to) {
        ...
        try (ByteArrayOutputStream out = new ByteArrayOutputStream()) {
            ...
            Font h1 = new Font(Font.HELVETICA, 16, Font.BOLD, new Color(10, 61, 98));
            Font h2 = new Font(Font.HELVETICA, 12, Font.BOLD, new Color(10, 61, 98));
            Font small = new Font(Font.HELVETICA, 9, Font.NORMAL, new Color(90, 90, 90));
            Font cellFont = new Font(Font.HELVETICA, 9, Font.NORMAL);
            Font cellBold = new Font(Font.HELVETICA, 9, Font.BOLD);
    ...
    private void addHeaderCell(PdfPTable table, String text, Font font) {
        ...
        cell.setBackgroundColor(new Color(10, 61, 98));
        cell.setPadding(5);
